...
- This project is managed in Linear.
...
- Add a concise Linear comment with what changed and what was verified.
- If a nearby issue would be affected or seems duplicated, stop and ask before merging scopes.

Do not silently combine two Linear issues into one implementation.
